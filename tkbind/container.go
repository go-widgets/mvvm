...
// toolkit container/layout model — the view's children follow the view
...
// Which card shows is a view-model concern (driven by a bound active index), so the binding is VM→view only. Returns an unbind that
